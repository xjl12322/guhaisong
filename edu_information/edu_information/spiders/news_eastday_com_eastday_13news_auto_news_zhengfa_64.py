...
class XueqianSpider(scrapy.Spider):
    name = "news_eastday_com_eastday_13news_auto_news_zhengfa_64"
    # allowed_domains = ["news.eastday.com"]
    start_urls = ["http://news.eastday.com/eastday/13news/auto/news/zhengfa/index_K42.html"]
    ...
    def parse_detail(self,response):
        ...
        #标题title
        title =  response.xpath('//h1[@id="biaoti"]/text()').extract_first(default="")
        title = title.strip()
        ...
        if title:
            ...
            index_node = response.xpath('string(//div[@class="center lh32 grey12a"])').extract_first()
