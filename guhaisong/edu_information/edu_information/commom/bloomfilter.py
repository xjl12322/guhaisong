...
from edu_information.commom.db_settings import REDISDB,CONRENT_CONF
...
class BloomFilter(object):
    def __init__(self, host=REDISDB[CONRENT_CONF]["REDIS_HOST"], port=REDISDB[CONRENT_CONF]["REDIS_PORT"], db=REDISDB[CONRENT_CONF]["REDIS_DB"], password=REDISDB[CONRENT_CONF]["REDIS_PASSWORD"],blockNum=1, key='bloomfilter:bloomfilter'):
        """
