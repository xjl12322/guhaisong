...
class XueqianSpider(scrapy.Spider):
    name = "tech_huanqiu_com_business_82"
    # allowed_domains = ["eol.cn"]
    start_urls = ["http://tech.huanqiu.com/business/","http://tech.huanqiu.com/internet/"]
...
#             yield scrapy.Request(next_page, callback=self.parse)
    ...
    def parse_detail(self,response):
        ...
        if title:
            ...
            content = content.replace("【环球网科技频道】", "")
            content = content.replace("【环球网科技综合报道】", "")
