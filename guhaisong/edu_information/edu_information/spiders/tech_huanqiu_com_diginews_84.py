...
class XueqianSpider(scrapy.Spider):
    name = "tech_huanqiu_com_diginews_84"
    # allowed_domains = ["eol.cn"]
    start_urls = ["http://tech.huanqiu.com/diginews/","http://tech.huanqiu.com/digiEnterprise/"]
...
#             yield scrapy.Request(next_page, callback=self.parse)
    ...
    def parse_detail(self,response):
        ...
        if title:
            ...
            content = content.replace("【环球网数码频道】", "")
            content = content.replace("【环球网数码综合报道】", "")
