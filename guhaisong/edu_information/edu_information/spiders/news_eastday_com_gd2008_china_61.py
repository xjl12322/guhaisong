...
class XueqianSpider(scrapy.Spider):
    name = "news_eastday_com_gd2008_china_61"
    # allowed_domains = ["news.eastday.com"]
    start_urls = ["http://news.eastday.com/gd2008/china/index.html","http://news.eastday.com/eastday/13news/auto/news/china/index_K34.html"]
    ...
    def parse_detail(self,response):
        ...
        if title:
            ...
            try:
                ...
                summary = summary.replace("东方网-东方新闻-中国新闻-", "")
