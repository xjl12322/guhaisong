...
class XueqianSpider(scrapy.Spider):
    name = "smart_huanqiu_com_ai_80"
    # allowed_domains = ["eol.cn"]
    start_urls = ["http://smart.huanqiu.com/ai/","http://smart.huanqiu.com/roll/","http://smart.huanqiu.com/original/","http://smart.huanqiu.com/vr/","http://smart.huanqiu.com/iot/","http://smart.huanqiu.com/city/","http://smart.huanqiu.com/product/"]
...
#             yield scrapy.Request(next_page, callback=self.parse)
    ...
    def parse_detail(self,response):
        ...
        if title:
            ...
            content = content.replace("【环球网智能综合报道】", "")
            content = content.replace("【环球网智能频道】", "")
