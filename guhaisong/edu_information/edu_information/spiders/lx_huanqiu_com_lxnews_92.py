...
class XueqianSpider(scrapy.Spider):
    name = "lx_huanqiu_com_lxnews_92"
    # allowed_domains = ["eol.cn"]
    start_urls = ["http://lx.huanqiu.com/lxnews/","http://lx.huanqiu.com/zhinan/","http://lx.huanqiu.com/immigration/","http://lx.huanqiu.com/scholarships/"]
...
#             yield scrapy.Request(next_page, callback=self.parse)
    ...
    def parse_detail(self,response):
        ...
        if title:
            ...
            content = content.replace("【环球网留学综合报道】", "")
            content = content.replace("【环球网留学频道】", "")
