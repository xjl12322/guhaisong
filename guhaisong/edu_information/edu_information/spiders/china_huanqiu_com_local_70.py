...
class XueqianSpider(scrapy.Spider):
    name = "china_huanqiu_com_local_70"
    # allowed_domains = ["eol.cn"]
    start_urls = ["http://china.huanqiu.com/local/","http://city.huanqiu.com/county/","http://city.huanqiu.com/travel/"]
...
#             yield scrapy.Request(next_page, callback=self.parse)
    ...
    def parse_detail(self,response):
        ...
        if title:
            ...
            content = content.replace("【环球网区域频道】", "")
