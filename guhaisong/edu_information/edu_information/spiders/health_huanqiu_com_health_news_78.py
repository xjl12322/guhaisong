...
class XueqianSpider(scrapy.Spider):
    name = "health_huanqiu_com_health_news_78"
    # allowed_domains = ["eol.cn"]
    start_urls = ["http://health.huanqiu.com/health_news/","http://health.huanqiu.com/yigai/news/","http://health.huanqiu.com/healthindustry/","http://health.huanqiu.com/health_promotion/","http://health.huanqiu.com/food_safety/","http://health.huanqiu.com/baby/"]
...
#             yield scrapy.Request(next_page, callback=self.parse)
    ...
    def parse_detail(self,response):
        ...
        if title:
            ...
            content = content.replace("【环球网健康频道】", "")
