...
class GovBuy(object):
    ...
    def __init__(self):
        ...
        self.rq = Rdis_Queue(host='localhost', dblist='yinchuan_ycsggzy_cn_list1', dbset='yinchuan_ycsggzy_cn_set1')
    ...
    def run(self):
        ...
        task_li = [
                {'categoryId':'12', 'types':'0','all_page': 2},
                {'categoryId':'12', 'types':'2','all_page': 1},
                {'categoryId':'17', 'types':'0','all_page': 2},
                {'categoryId':'17', 'types':'1','all_page': 2},
                {'categoryId':'17', 'types':'2','all_page': 1},
